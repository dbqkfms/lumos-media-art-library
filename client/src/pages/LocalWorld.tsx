                ...
                >
                  ...
                  <div className="relative overflow-hidden aspect-video bg-[#111]">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <div className="w-10 h-10 rounded-full bg-[#93C5FD]/20 backdrop-blur-sm border border-[#93C5FD]/40 flex items-center justify-center">
                        <div className="w-0 h-0 border-t-[6px] border-t-transparent border-b-[6px] border-b-transparent border-l-[10px] border-l-[#93C5FD] ml-0.5" />
                      </div>
                    </div>
                  </div>
